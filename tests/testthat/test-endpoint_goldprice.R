...
test_that("Base url is defined properly", {
  ...
  expect_equal(base_url, "http://api.nbp.pl/api/cenyzlota/")
})
...
with_mock_api({
  test_that("Current gold price is fetched correctly", {
    ...
    expect_equal(nbp_api_response$content$data, "2019-07-19")
  ...
  test_that("Last n gold prices are fetched correctly", {
    ...
    expect_equal(nbp_api_response$content$data, c("2019-07-18", "2019-07-19"))
  ...
  test_that("Gold price from specific date is fetched correctly", {
    ...
    expect_equal(nbp_api_response$content$data, "2019-07-12")
  ...
  test_that("Gold prices from specific interval are fetched correctly", {
    ...
    expect_equal(nbp_api_response$content$data, c("2019-07-15", "2019-07-16"))
