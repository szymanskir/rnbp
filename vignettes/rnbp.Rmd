...
The goal of this document is to present the functionalities of the package along with examples on how the retrieved data can be used. All of the endpoints expose the same set of of functionalites:
...
The NBP API exposes endpoints for retrieving exchange rate tables. At the time of writting this document three tables are available:
